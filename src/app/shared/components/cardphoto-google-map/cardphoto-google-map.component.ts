...
@Component({
  selector: 'app-cardphoto-google-map',
  templateUrl: './cardphoto-google-map.component.html',
  styleUrls: ['./cardphoto-google-map.component.scss'],
})
export class CardphotoGoogleMapComponent implements OnInit {
