...
(function () {
	...
	(d = function (a, b) {
		...
		(e = function (a, b) {
			var c, d, e, f, g, h;
			for (
				c = a, f = b.split('.'), d = g = 0, h = f.length;
				h > g && ((e = f[d]), (c = c[e]), 'object' == typeof c);
				d = ++g
			);
		...
		(a.getOption = function (b) {
			var d, f;
			return (
				(d = null != (f = e(a.options, b)) ? f : e(c, b)),
			...
			return (
				...
				null === a.onprogress
					? (a.addEventListener('error', c, !1),
					  a.addEventListener('timeout', c, !1),
					  a.addEventListener('load', d, !1))
					: ((e = a.onreadystatechange),
					  (a.onreadystatechange = function () {
							return (
								4 === a.readyState ? d() : 0 === a.readyState && c(),
			...
			return (
				a.getOption('interceptRequests') &&
					a.onXHR(function (c) {
						...
						return (
							(d = c.xhr),
							d.offline !== !1 ? b(d, a.confirmUp, a.confirmDown) : void 0
						);
					}),
	...
	function () {
		...
		(c = []),
			...
			(b = function () {
				var b, d, f, g, h, i;
				for (
					Offline.trigger('requests:flush'), f = {}, h = 0, i = c.length;
					i > h;
					h++
				)
					(d = c[h]),
								...
								b)
									? null === e.onprogress
										? (e.addEventListener('error', c, !1),
										  e.addEventListener('timeout', c, !1))
	...
	function () {
		...
		for (e = ['up', 'down'], c = 0, d = e.length; d > c; c++)
			(a = e[c]),
				(document.querySelector("script[data-simulate='" + a + "']") ||
					localStorage.OFFLINE_SIMULATE === a) &&
					(null == Offline.options && (Offline.options = {}),
					null == (b = Offline.options).checks && (b.checks = {}),
					(Offline.options.checks.active = a));
	}.call(this),
	function () {
		...
		(b =
			...
			(j = function (a) {
				return (f.className = f.className.replace(
				...
				return (
					...
					Offline.on('reconnect:tick', function () {
						...
						return (
							...
							j('offline-ui-connecting'),
							(e = l(Offline.reconnect.remaining)),
							(a = e[0]),
							(b = e[1]),
							d.setAttribute('data-retry-in-value', a),
							d.setAttribute('data-retry-in-unit', b)
						);
					}),
					Offline.on('reconnect:stopped', function () {
						return (
							j('offline-ui-connecting offline-ui-waiting'),
							d.setAttribute('data-retry-in-value', null),
					...
					Offline.on('reconnect:failure', function () {
						return (
							...
							g('offline-ui-reconnect-failed-5s', 5)
						);
					}),
					Offline.on('reconnect:success', function () {
						return (
							g('offline-ui-reconnect-succeeded-2s', 2),
							g('offline-ui-reconnect-succeeded-5s', 5)
						);
					})
				);
			}),
				...
				: ((m = document.onreadystatechange),
				  (document.onreadystatechange = function () {
						return (
							...
							'function' == typeof m ? m.apply(null, arguments) : void 0
						);
				  }));
	}.call(this));
